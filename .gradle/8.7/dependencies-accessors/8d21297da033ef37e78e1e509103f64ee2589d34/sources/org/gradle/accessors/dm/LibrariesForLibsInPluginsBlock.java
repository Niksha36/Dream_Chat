...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    /**
     * Group of libraries at <b>stream</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public StreamLibraryAccessors getStream() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForStreamLibraryAccessors;
    }
    ...
    public static class StreamLibraryAccessors extends SubDependencyFactory {
        private final StreamChatLibraryAccessors laccForStreamChatLibraryAccessors = new StreamChatLibraryAccessors(owner);

        public StreamLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>stream.chat</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public StreamChatLibraryAccessors getChat() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForStreamChatLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class StreamChatLibraryAccessors extends SubDependencyFactory {
        private final StreamChatAndroidLibraryAccessors laccForStreamChatAndroidLibraryAccessors = new StreamChatAndroidLibraryAccessors(owner);

        public StreamChatLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>stream.chat.android</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public StreamChatAndroidLibraryAccessors getAndroid() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForStreamChatAndroidLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class StreamChatAndroidLibraryAccessors extends SubDependencyFactory {
        private final StreamChatAndroidMarkdownLibraryAccessors laccForStreamChatAndroidMarkdownLibraryAccessors = new StreamChatAndroidMarkdownLibraryAccessors(owner);
        private final StreamChatAndroidUiLibraryAccessors laccForStreamChatAndroidUiLibraryAccessors = new StreamChatAndroidUiLibraryAccessors(owner);

        public StreamChatAndroidLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>client</b> with <b>io.getstream:stream-chat-android-client</b> coordinates and
         * with version reference <b>streamChatAndroidClient</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getClient() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("stream.chat.android.client");
        }

        /**
         * Dependency provider for <b>offline</b> with <b>io.getstream:stream-chat-android-offline</b> coordinates and
         * with version reference <b>streamChatAndroidClient</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
        ...
        public Provider<MinimalExternalModuleDependency> getOffline() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("stream.chat.android.offline");
        }

        /**
         * Group of libraries at <b>stream.chat.android.markdown</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public StreamChatAndroidMarkdownLibraryAccessors getMarkdown() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForStreamChatAndroidMarkdownLibraryAccessors;
        }

        /**
         * Group of libraries at <b>stream.chat.android.ui</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public StreamChatAndroidUiLibraryAccessors getUi() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForStreamChatAndroidUiLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class StreamChatAndroidMarkdownLibraryAccessors extends SubDependencyFactory {

        public StreamChatAndroidMarkdownLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>transformer</b> with <b>io.getstream:stream-chat-android-markdown-transformer</b> coordinates and
         * with version reference <b>streamChatAndroidClient</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
        ...
        public Provider<MinimalExternalModuleDependency> getTransformer() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("stream.chat.android.markdown.transformer");
        }
     ...
     */
    @Deprecated
    public static class StreamChatAndroidUiLibraryAccessors extends SubDependencyFactory {

        public StreamChatAndroidUiLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>components</b> with <b>io.getstream:stream-chat-android-ui-components</b> coordinates and
         * with version reference <b>streamChatAndroidUiComponents</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getComponents() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("stream.chat.android.ui.components");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>navigationSafeArgs</b> with value <b>2.7.7</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>streamChatAndroidClient</b> with value <b>6.5.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getStreamChatAndroidClient() { return getVersion("streamChatAndroidClient"); }

        /**
         * Version alias <b>streamChatAndroidUiComponents</b> with value <b>6.5.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getStreamChatAndroidUiComponents() { return getVersion("streamChatAndroidUiComponents"); }
    ...
    public static class AndroidxNavigationPluginAccessors extends PluginFactory {
        private final AndroidxNavigationSafeargsPluginAccessors paccForAndroidxNavigationSafeargsPluginAccessors = new AndroidxNavigationSafeargsPluginAccessors(providers, config);

        public AndroidxNavigationPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Group of plugins at <b>plugins.androidx.navigation.safeargs</b>
         */
        public AndroidxNavigationSafeargsPluginAccessors getSafeargs() {
            return paccForAndroidxNavigationSafeargsPluginAccessors;
        }

    }

    public static class AndroidxNavigationSafeargsPluginAccessors extends PluginFactory {

        public AndroidxNavigationSafeargsPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Plugin provider for <b>androidx.navigation.safeargs.kotlin</b> with plugin id <b>androidx.navigation.safeargs.kotlin</b> and
         * with version reference <b>navigationSafeArgs</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getKotlin() { return createPlugin("androidx.navigation.safeargs.kotlin"); }
